...
public class GenerateInteger extends AnAction {
	...
	public void actionPerformed(final AnActionEvent e) {
		...
		final Runnable command = new Runnable() {
			@Override
			public void run() {
				ApplicationManager.getApplication().runWriteAction(Inserter.create(e, "", Integer.toString(RND.nextInt()), ""));
			}
		};
		final String name = "Generate Integer Literal";
