...
public class GenerateLong extends AnAction {
	...
	public void actionPerformed(final AnActionEvent e) {
		...
		final Runnable command = new Runnable() {
			@Override
			public void run() {
				ApplicationManager.getApplication().runWriteAction(Inserter.create(e, "", Long.toString(RND.nextLong()), "L"));
			}
		};
		final String name = "Generate Long Literal";
